...
HOST="${DB_HOST:-rds-technova-endpoint}"
PORT=3306
USER="${DB_USER:-admin}"                   # Cambiar por tu usuario
PASS="${DB_PASSWORD:-Duoc.1234}"          # cambiar por tu password
DBNAME="${DB_NAME:-technova}"   # base de datos creada en RDS para la app

CURRENT_CLASS="db.t3.micro"
